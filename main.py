...
def main():
    ...
    args.store_name += "_fft_dct_res1234_1x1conv_tanh_ALL"
...
def train(train_loader, model, criterion, optimizer, epoch, log, tf_writer,  wandb):
    ...
    wandb.log({
        ...
        'train_top@1': top1.avg,
        'train_top@5': top5.avg
    })



def validate(val_loader, model, criterion, epoch, log=None, tf_writer=None, wandb=None):
    batch_time = AverageMeter()
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
