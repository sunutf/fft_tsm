...
class TSN(nn.Module):
    def __init__(self, num_class, num_segments, modality,
                 ...
                 temporal_pool=False, non_local=False, is_rnn=False, rnn_rate_list=None, hidden_dim = 512):
    ...
    TSN Configurations:
        ...
        if self.is_rnn :
            self._prepare_rnns(feature_dim, self.hidden_dim)
    ...
    def _prepare_rnns(self, input_dim, hidden_dim):
        for _ in range(len(self.rnn_rate_list)):
            self.rnn_list.append(torch.nn.LSTMCell(input_size=input_dim, hidden_size=hidden_dim))
    ...
    def rnn_forward(self, input):
        ...
        return hx_t.view(b_*len(self.rnn_list), -1)
